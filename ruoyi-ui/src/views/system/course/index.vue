<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程状态" prop="isDel">
        <el-select v-model="queryParams.isDel" placeholder="请选择课程状态" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程状态" align="center" prop="isDel">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_job_status" :value="scope.row.isDel"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="讲师" prop="trainer">
          <el-select v-model="form.trainer" placeholder="请选择讲师">
            <el-option
              v-for="dict in trainerList"
              :key="dict.fullName"
              :label="dict.fullName"
              :value="dict.fullName"
            ></el-option>
        ...
        <el-form-item label="课程费用" prop="coursePrice">
          <el-input-number v-model="form.coursePrice" placeholder="请输入课程费用" />
        </el-form-item>
        <el-form-item label="课程状态" prop="isDel">
          <el-select v-model="form.isDel" placeholder="请选择课程状态">
            <el-option
              v-for="dict in dict.type.sys_job_status"
              :key="dict.value"
              :label="dict.label"
...
import {getTrainers} from "@/api/system/trianer";
