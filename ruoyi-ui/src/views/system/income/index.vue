<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="总收入" prop="totalPrice">
        <el-input
    ...
    <el-table v-loading="loading" :data="incomeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收入ID" align="center" prop="id" />
      <el-table-column label="课程名" align="center" prop="courseName" />
      <el-table-column label="选课人数" align="center" prop="number" />
      <el-table-column label="价格" align="center" prop="price" />
      <el-table-column label="总收入" align="center" prop="totalPrice" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="选课人数" prop="number">
          <el-input v-model="form.number" placeholder="请输入选课人数" />
        </el-form-item>
        <el-form-item label="价格" prop="price">
          <el-input v-model="form.price" placeholder="请输入价格" />
        </el-form-item>
        <el-form-item label="总收入" prop="totalPrice">
          <el-input v-model="form.totalPrice" placeholder="请输入总收入" />
        </el-form-item>
      </el-form>
...
<script>
import { listIncome, getIncome, delIncome, addIncome, updateIncome } from "@/api/system/income";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课程收入编号为"' + ids + '"的数据项？').then(function() {
